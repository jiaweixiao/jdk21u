...
class G1PostGroupMarkingPreparationTask2 : public G1BatchedTask {
  // class MergePssLoggedCardsTask;
  class RedirtyLoggedCardsTask;

public:
  G1PostGroupMarkingPreparationTask2(G1ParScanThreadStateSet* per_thread_states, G1EvacFailureRegions* evac_failure_regions);
};
